                    ...
                    <div class="h-full grid content-around">
                        ...
                        <div id="game{{ $game->id }}" next-game-id="{{ $game->next_game_id }}"
                            ...
                            <a data-modal-target="game{{ $game->id }}-modal" data-modal-toggle="game{{ $game->id }}-modal" data-team-id="{{ $game->team1 ? $game->team1->id : 'null' }}"
                                ...
                                <span class="mr-0 ml-auto {{ $game->team1 && ($game->tournament->maps_each_game == 0 ? ($game->maps->isNotEmpty() ? $game->maps->first()->team1_score : 0) : ($game->team1_maps_won ? $game->team1_maps_won : 0)) ? 'text-blue-500' : 'text-gray-500' }}">
                                    {{ ($game->team1 ? ($game->tournament->maps_each_game == 0 ? ($game->maps->isNotEmpty() ? $game->maps->first()->team1_score : 0) : ($game->team1_maps_won ? $game->team1_maps_won : 0)) : 0) }}
                                </span>
                            </a>
                            <a data-modal-target="game{{ $game->id }}-modal" data-modal-toggle="game{{ $game->id }}-modal" data-team-id="{{ $game->team2 ? $game->team2->id : 'null' }}"
                                ...
                                <span class="mr-0 ml-auto {{ $game->team2 && ($game->tournament->maps_each_game == 0 ? ($game->maps->isNotEmpty() ? $game->maps->first()->team2_score : 0) : ($game->team2_maps_won ? $game->team2_maps_won : 0)) ? 'text-blue-500' : 'text-gray-500' }}">
                                    {{ ($game->team2 ? ($game->tournament->maps_each_game == 0 ? ($game->maps->isNotEmpty() ? $game->maps->first()->team2_score : 0) : ($game->team2_maps_won ? $game->team2_maps_won : 0)) : 0) }}
                                </span>
                            </a>
                        </div>
                        @endforeach
