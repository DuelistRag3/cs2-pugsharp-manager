            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4">
                        ...
                        DateTime($tournament->registration_deadline)->format('d.m.Y H:i') : 'Turnierstart' }}
                    </td>
                    <td class="px-6 py-4">
                        {{ $tournament->start_date ? new DateTime($tournament->start_date)->format('d.m.Y H:i') : 'Nicht
                        festgelegt' }}
                    </td>
                    <td class="px-6 py-4">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <form wire:submit="create" class="">
                        ...
                        <div class="mb-5">
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white @error('name') dark:text-red-500! @enderror">Turniername
                        ...
                        <div class="mb-5">
                            <label for="description"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white  @error('description') dark:text-red-500! @enderror">Beschreibung
                        ...
                        <div class="mb-5">
                            <label for="registration_deadline"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white @error('registration_deadline') dark:text-red-500! @enderror">Anmeldeschluss
                                (Optional) @error('registration_deadline') ({{ $message }}) @enderror</label>
                            <input wire:model.blur='registration_deadline' type="datetime-local"
                                id="registration_deadline"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Anmeldeschluss" />
                            <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">Wenn
                                nicht angegeben endet die Registrierung mit Turnierbeginn.</p>
                        </div>
                        <div class="mb-5">
                            <label for="start_date"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white @error('start_date') dark:text-red-500! @enderror">Startdatum
                        ...
                        <div class="mb-5">
                            <label for="team_size"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white @error('team_size') dark:text-red-500! @enderror">Teamgröße
                        ...
                        <div class="mb-5">
                            <label for="maps_each_game"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white @error('maps_each_game') dark:text-red-500! @enderror">Matchup-Runden
                        ...
                        <div class="mb-5">
                            <label for="maps_final_game"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white @error('maps_final_game') dark:text-red-500! @enderror">Final-Runden
                        ...
                        <div class="mb-5">
                            <label for="map_rounds"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white @error('map_rounds') dark:text-red-500! @enderror">Runden
                                pro Match @error('map_rounds') ({{ $message }}) @enderror</label>
                            <input wire:model.blur='map_rounds' type="number" id="map_rounds"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Runden pro Match" required />
                            <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                Standardmäßig 24 Runden für CS2.</p>
                        </div>
                        <div class="mb-5">
                            <label for="map_overtime_rounds"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white @error('map_overtime_rounds') dark:text-red-500! @enderror">Overtime-Runden
                            ...
                            <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                Standardmäßig 6 Overtime-Runden für CS2.</p>
                        </div>
                </div>
                <!-- Modal footer -->
