        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 mb-2">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4">
                        <button wire:click="editServerModal({{ $server->id }})" data-modal-target="edit-modal" data-modal-toggle="edit-modal"
                            class="cursor-pointer text-xs text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg p-2.5 text-center inline-flex items-center me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                            <i class="fa-solid fa-pen"></i>
                            <span class="sr-only">{{ __('manager.edit') }}</span>
    ...
    <div id="edit-modal" tabindex="-1" aria-hidden="true" wire:ignore.self
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <form wire:submit="updateServer()" class="">
                        <div class="mb-5">
                            <label for="ip"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('manager.ip_address') }} / {{ __('manager.hostname') }}</label>
                            <input wire:model='ip' id="ip" type="text"
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button type="submit"
                        class="cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('manager.save') }}</button>
                    </form>
